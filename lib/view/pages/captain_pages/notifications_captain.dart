...
class NotificationsCaptain extends StatefulWidget {
  @override
  _NotificationsCaptainState createState() {
    return _NotificationsCaptainState();
  }
}

class _NotificationsCaptainState extends State<NotificationsCaptain> {
